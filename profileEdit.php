<?php
	...
	if(isset($_POST['screenName'])){
		if(!empty($_POST['screenName'])){
			...
			}else if(strlen($profileBio) > 140){
				$error = "Bio is too long!";
			}else if(strlen($country) > 80){
				$error = "Country is too big to fit in!";
			}else{
			  ...
			  <!-- img upload end-->
					...
					<ul>
	 					<?php
							if(isset($imageError)){
								echo '<ul> 
										<li class="error-li">
					  						<div class="span-fp-error">'.$imageError.'</div>
					 					</li>
					 				</ul> ';
							}
						?>
				...
				<div class="profile-bio-wrap">
					<div class="profile-bio-inner">
						<textarea class="status" name="profileBio"><?php echo $user->bio;?></textarea>
						<div class="hash-box">
					 		<ul>
					 		</ul>
					 	</div>
